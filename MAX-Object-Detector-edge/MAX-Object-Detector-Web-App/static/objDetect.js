...
const apiServer =  '/model/predict';//the full TensorFlow Object Detection API server url
...
function postFile(file) {
    ...
    xhr.onload = function () {
        if (this.status === 200) {
            ...
            var processingTime = parseFloat(objects.processingTime);
            ...
            document.getElementById('overall-max-resp-time').innerHTML=Math.max(...edgeDataArray).toFixed(2)+' ms';
