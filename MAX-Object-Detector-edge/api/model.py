...
predict_response = api.model('ModelPredictResponse', {
    ...
    'requestTimestamp': fields.Float(required=True, description='Response status message'),
    'processingStart': fields.Float(required=True, description='Response status message'),
    'processingEnd': fields.Float(required=True, description='Response status message'),
    'processingTime': fields.Float(required=True, description='Response status message'),
    'requestTime': fields.Float(required=True, description='Response status message'),
...
image_parser.add_argument('requestTimestamp', type=float, default=0.7, help='Probability threshold for including a detected object in the response in the range [0, 1] (default: 0.7). Lowering the threshold includes objects the model is less certain about.')
